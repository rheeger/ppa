...
class BaseCard(BaseModel):
    ...
    def validate_uid_prefix(cls, value: str) -> str:
        ...
        if not value.startswith(f"{prefix}-"):
            raise ValueError(f"uid must start with '{prefix}-'")
        return value
...
def get_card_type_spec(card_type: str):
    ...
    from archive_vault.card_contracts import get_card_type_spec as _get_card_type_spec
...
def iter_card_type_specs():
    ...
    from archive_vault.card_contracts import iter_card_type_specs as _iter_card_type_specs
