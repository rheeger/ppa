...
from archive_vault.schema import CARD_TYPES, DETERMINISTIC_ONLY, LLM_ELIGIBLE, BaseCard
...
_CARD_TYPE_METADATA: dict[str, dict[str, object]] = {
    ...
    "meal_order": {
        "rel_path_family": "Transactions/MealOrders",
        "external_id_fields": ("source_id",),
        "relationship_fields": ("people", "orgs", "source_email"),
        "chunk_profile": "default",
        "edge_profile": "meal_order",
        "typed_projection": "meal_orders",
    },
    "grocery_order": {
        "rel_path_family": "Transactions/Groceries",
        "external_id_fields": ("source_id",),
        "relationship_fields": ("people", "orgs", "source_email"),
        "chunk_profile": "default",
        "edge_profile": "grocery_order",
        "typed_projection": "grocery_orders",
    },
    "ride": {
        "rel_path_family": "Transactions/Rides",
        "external_id_fields": ("source_id",),
        "relationship_fields": ("people", "orgs", "source_email"),
        "chunk_profile": "default",
        "edge_profile": "ride",
        "typed_projection": "rides",
    },
    "flight": {
        "rel_path_family": "Transactions/Flights",
        "external_id_fields": ("source_id", "confirmation_code"),
        "relationship_fields": ("people", "orgs", "source_email"),
        "chunk_profile": "default",
        "edge_profile": "flight",
        "typed_projection": "flights",
    },
    "accommodation": {
        "rel_path_family": "Transactions/Accommodations",
        "external_id_fields": ("source_id", "confirmation_code"),
        "relationship_fields": ("people", "orgs", "source_email"),
        "chunk_profile": "default",
        "edge_profile": "accommodation",
        "typed_projection": "accommodations",
    },
    "car_rental": {
        "rel_path_family": "Transactions/CarRentals",
        "external_id_fields": ("source_id", "confirmation_code"),
        "relationship_fields": ("people", "orgs", "source_email"),
        "chunk_profile": "default",
        "edge_profile": "car_rental",
        "typed_projection": "car_rentals",
    },
    "purchase": {
        "rel_path_family": "Transactions/Purchases",
        "external_id_fields": ("source_id", "order_number"),
        "relationship_fields": ("people", "orgs", "source_email"),
        "chunk_profile": "default",
        "edge_profile": "purchase",
        "typed_projection": "purchases",
    },
    "shipment": {
        "rel_path_family": "Transactions/Shipments",
        "external_id_fields": ("source_id", "tracking_number"),
        "relationship_fields": ("people", "orgs", "source_email", "linked_purchase"),
        "chunk_profile": "default",
        "edge_profile": "shipment",
        "typed_projection": "shipments",
    },
    "subscription": {
        "rel_path_family": "Transactions/Subscriptions",
        "external_id_fields": ("source_id",),
        "relationship_fields": ("people", "orgs", "source_email"),
        "chunk_profile": "default",
        "edge_profile": "subscription",
        "typed_projection": "subscriptions",
    },
    "event_ticket": {
        "rel_path_family": "Transactions/EventTickets",
        "external_id_fields": ("source_id", "confirmation_code"),
        "relationship_fields": ("people", "orgs", "source_email"),
        "chunk_profile": "default",
        "edge_profile": "event_ticket",
        "typed_projection": "event_tickets",
    },
    "payroll": {
        "rel_path_family": "Transactions/Payroll",
        "external_id_fields": ("source_id",),
        "relationship_fields": ("people", "orgs", "source_email"),
        "chunk_profile": "default",
        "edge_profile": "payroll",
        "typed_projection": "payroll_records",
    },
    "place": {
        "rel_path_family": "Entities/Places",
        "external_id_fields": ("source_id",),
        "relationship_fields": ("people", "orgs"),
        "chunk_profile": "default",
        "edge_profile": "default",
        "typed_projection": "places",
    },
    "organization": {
        "rel_path_family": "Entities/Organizations",
        "external_id_fields": ("source_id", "domain"),
        "relationship_fields": ("people", "orgs"),
        "chunk_profile": "default",
        "edge_profile": "default",
        "typed_projection": "organizations",
    },
    "knowledge": {
        "rel_path_family": "Knowledge",
        "external_id_fields": ("source_id",),
        "relationship_fields": ("people", "orgs"),
        "chunk_profile": "default",
        "edge_profile": "default",
        "typed_projection": "knowledge_cards",
    },
    "observation": {
        "rel_path_family": "Agent",
        "external_id_fields": ("source_id",),
        "relationship_fields": ("people", "orgs", "evidence_uids"),
        "chunk_profile": "default",
        "edge_profile": "observation",
