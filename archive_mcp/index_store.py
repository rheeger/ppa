...
from .chunk_builders import (  # noqa: F401 — re-exported for backward compat
    _build_calendar_event_chunks, _build_chunks, _build_document_chunks,
    _build_email_message_chunks, _build_email_thread_chunks,
    _build_git_commit_chunks, _build_git_message_chunks,
    _build_git_repository_chunks, _build_git_thread_chunks,
    _build_imessage_thread_chunks, _build_meeting_transcript_chunks,
    _build_person_chunks, _chunk_hash, _colon_speaker_turns,
    _format_labeled_block, _markdown_heading_sections,
    _meeting_transcript_focus_section, _otter_pipe_turns,
    _rolling_text_windows, _split_paragraphs, _split_text_chunks, _token_count)
...
from .features import (CHUNKABLE_TEXT_FIELDS, TIMELINE_FIELDS,  # noqa: F401
                       build_context_prefix_for_embed_row, card_activity_at,
                       iter_external_ids, json_text, primary_person)
from .index_config import (  # noqa: F401 — re-exported for backward compat
    CARD_TYPE_PRIORS, CHUNK_SCHEMA_VERSION, DEFAULT_CHUNK_CHAR_LIMIT,
    DEFAULT_EMBED_BATCH_SIZE, DEFAULT_EMBED_CONCURRENCY,
    DEFAULT_EMBED_MAX_RETRIES, DEFAULT_EMBED_PROGRESS_EVERY,
    DEFAULT_EMBEDDING_MODEL, DEFAULT_EMBEDDING_VERSION,
    DEFAULT_POSTGRES_SCHEMA, DEFAULT_REBUILD_BATCH_SIZE,
    DEFAULT_REBUILD_COMMIT_INTERVAL, DEFAULT_REBUILD_EXECUTOR,
    DEFAULT_REBUILD_FLUSH_MAX_BYTES, DEFAULT_REBUILD_FLUSH_MAX_CHUNKS,
    DEFAULT_REBUILD_FLUSH_MAX_EDGES, DEFAULT_REBUILD_FLUSH_ROW_MULT,
    DEFAULT_REBUILD_PROGRESS_EVERY, DEFAULT_REBUILD_WORKERS,
    DEFAULT_VECTOR_DIMENSION, EDGE_RULE_BY_CARD_TYPE, HASH_SUFFIX_RE,
    INDEX_SCHEMA_VERSION, LOW_CONFIDENCE_FIELDS, MANIFEST_SCHEMA_VERSION,
    PROJECTIONS_BY_LOAD_ORDER, SCAN_MANIFEST_VERSION,
    VECTOR_CANDIDATE_MULTIPLIER, EmbeddingBatchResult, _activity_date,
    _apply_recency_boost, _card_type_prior, _coerce_source_fields,
    _field_provenance_bonus, _field_provenance_label, _format_row,
    _vector_literal, embed_defer_vector_index, get_chunk_char_limit,
    get_default_embedding_model, get_default_embedding_version,
    get_embed_batch_size, get_embed_concurrency, get_embed_max_retries,
    get_embed_progress_every, get_embed_write_batch_size,
    get_force_full_rebuild, get_index_dsn, get_index_schema,
    get_rebuild_batch_size, get_rebuild_commit_interval, get_rebuild_executor,
    get_rebuild_progress_every, get_rebuild_resume, get_rebuild_staging_mode,
    get_rebuild_workers, get_seed_frozen_enabled, get_vector_dimension,
    manifest_cache_disabled)
from .index_query import QueryMixin
from .loader import (  # noqa: F401 — re-exported for backward compat
    PROJECTION_COLUMNS_BY_TABLE, PROJECTION_NAMES, TYPED_PROJECTION_TABLES,
...
from .materializer import (  # noqa: F401 — re-exported for backward compat
    _dedupe_rows, _iter_string_values, _materialize_row,
    _materialize_row_batch, _normalize_exact_text)
from .materializer import _normalize_slug as _normalize_slug  # noqa: F401
from .materializer import (  # noqa: F401 — re-exported for backward compat
    _resolve_person_reference, _resolve_slug, _slug_from_wikilink,
    _synthetic_external_id_path, _wikilinks_from_frontmatter)
...
from .projections.registry import (EDGE_RULE_SPECS, PROJECTION_REGISTRY,
                                   ...
                                   TYPED_PROJECTIONS, projection_for_card_type)
from .scanner import (  # noqa: F401 — re-exported for backward compat
    CanonicalRow, NoteManifestRow, _build_manifest_rows_from_canonical,
    _canonical_row_from_rel_path, _classify_manifest_rebuild_delta,
    _collect_canonical_rows, _frontmatter_hash_stable, _iter_canonical_rows,
    _note_manifest_row_from_materialized, _people_orgs_json_for_card,
    _register_slug, _row_sort_key, _vault_paths_and_fingerprint)
