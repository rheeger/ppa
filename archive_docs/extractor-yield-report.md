...
**CI / synthetic validation:** `pytest archive_tests/archive_sync/extractors/` covers parsers, runner, registry, entity resolution, and end-to-end staging + idempotency (no live vault required).
