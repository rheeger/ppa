...
| [v2.5vision.md](v2.5vision.md) | Production-hardening plan. A–E/G landed. Remaining: slice hygiene vault-remove + **updaters for every non-export stream** on 1pct/10pct, then seed-copy 5b. Manual exports stay import-only. Arnold deferred. |
