...
from archive_vault.vault import extract_wikilinks, iter_note_paths, read_note_file

from .benchmark import _orphan_metrics, _orphan_metrics_from_frontmatters, _stable_score
...
def slice_seed_vault(
    ...
    *,
    ...
    Logs to ``ppa.slice`` (stderr via :mod:`archive_cli.log`). For large vaults,
