"""``ppa source-updaters`` CLI — declarations and durable source health (Section D)."""
...
from archive_sync.source_updaters.constants import SECTION_D_COMPLETION_STATE
...
def add_parser(subparsers: argparse._SubParsersAction) -> None:
    parser = subparsers.add_parser(
        "source-updaters",
        help="Source updater declarations and health (Section D)",
    )
