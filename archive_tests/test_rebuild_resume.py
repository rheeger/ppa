...
from archive_cli.loader import _compute_run_id, _try_resume_checkpoint
...
from archive_tests.index_snapshot import snapshot_projection_state
...
def test_compute_run_id_changes_with_schema_version(monkeypatch: pytest.MonkeyPatch) -> None:
    import archive_cli.loader as loader
