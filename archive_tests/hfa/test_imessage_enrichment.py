...
from archive_vault.imessage_enrichment import IMessageThreadSummaryEnrichment
from archive_vault.provenance import ProvenanceEntry
from archive_vault.schema import IMessageMessageCard, IMessageThreadCard
from archive_vault.thread_hash import compute_imessage_thread_body_sha
...
def test_imessage_thread_summary_enrichment_tracks_message_content_hash(tmp_vault, monkeypatch):
    ...
    monkeypatch.setattr("archive_vault.imessage_enrichment.get_provider_chain", lambda vault_path: [provider])
    ...
    monkeypatch.setattr(
        "archive_vault.imessage_enrichment.compute_imessage_thread_body_sha",
