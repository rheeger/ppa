...
from archive_cli.index_store import _build_person_lookup, _collect_canonical_rows, _materialize_row_batch
...
from archive_vault.schema import MedicalRecordCard, PersonCard, VaccinationCard
