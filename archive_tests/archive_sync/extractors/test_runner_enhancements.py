...
from archive_sync.extractors.runner import ExtractionRunner, uid_in_vault_percent_sample
...
def test_full_report_staging_summary_non_empty(extractor_vault, sample_email_card, tmp_path):
    ...
    from archive_cli.commands.staging import format_staging_report_markdown, staging_report
